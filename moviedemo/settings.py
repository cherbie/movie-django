"""
Django settings for moviedemo project.
...
INSTALLED_APPS = [
    "moviedemo.apps.moviehub.apps.MovieHubConfig",
...
MIGRATION_MODULES = {
    "moviehub": "moviedemo.apps.moviehub.data.migrations",
}
...
WSGI_APPLICATION = "moviedemo.wsgi.application"
...
# Recognize the apps directory
sys.path.append(os.path.join(BASE_DIR, "moviedemo", "apps"))